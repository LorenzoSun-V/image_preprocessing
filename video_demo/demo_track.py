...
label_list3 = ['bank_staff_vest', 'cleaner', 'money_staff', 'person', 'security_staff', 'bank_staff_shirt', 'bank_staff_coat']

color_list = [ (0,255,0), (255,0,0),(0,0,255) ]
color_list2 = [(169,169,169),(0,255,255),(0,128,128),(130,0,75),(203,192,255)]
color_list3 = [(169,169,169),(0,255,255),(0,128,128),(130,0,75),(203,192,255),(0,165,255),(235,206,135)]
...
def traversal_videos(cfg):
	creat_log_dir(cfg)
	# videos in folder
	video_list = sorted(glob.glob(os.path.join(cfg.video_path, "*.mp4")))[7:10]
...
def parse_args():
	...
	parser.add_argument(
		...
		default="/mnt/shy/农行POC/abc_data/第八批1108/cut"
	...
	parser.add_argument(
		...
		default="/mnt/shy/sjh/农行data/第八批1108/"
		)
