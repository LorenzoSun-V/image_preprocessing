...
label_list = ['bank_staff_summer', 'bank_staff_fall', 'custom', 'security_staff']
color_list = [(169, 169, 169), (0, 0, 255), (130, 0, 75), (203, 192, 255)]
...
class MOT:
    def __init__(self, cfg, debug=False):
        ...
        self.cls_model = SoftFPN(detect_type='mob2staff4')
