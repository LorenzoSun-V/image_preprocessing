...
class Augmentation:
    ...
    def randomResizeCrop(self, image, mask, scale=(0.6, 1.0),
...
def augmentationData(image_path, mask_path, option=[2, 4, 6, 7], save_dir=None):
    '''
